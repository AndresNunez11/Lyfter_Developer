...
PATH_CSV_FILE = '04_Python_Intermedio\Ejercicios de Análisis de Algoritmos  Extra\Exercises.json'
            ...
            try:
                ...
                match option:
                    ...
                    case 1: 
                        ...
                        menu.answer_exercise1()                      
                        input('Presione [Enter] para continuar \n')
                    case 2:
                        print(f'{menu.list_exercise[2]}') 
                        menu.answer_exercise2()
                        input('Presione [Enter] para continuar')
                    case 3: 
                        print(f'{menu.list_exercise[3]}')  
                        menu.answer_exercise3()
                        input('Presione [Enter] para continuar')
                    case 4: 
