class ValidateExercises():

    def exercises_analist(self):
        print(f'#1 - print_numbers_times_2 // Big O = O(n)')
        print(f'#2 - check_if_lists_have_an_equal // Big O  = O(n^2)')
        print(f'#3 - print_10_or_less_elements // Big O  = O(1) ')
        print(f'#4 - generate_list_trios // Big O  = O(n^3)')
