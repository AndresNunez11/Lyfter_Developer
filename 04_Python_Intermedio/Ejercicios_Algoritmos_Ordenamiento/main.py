...
PATH_CSV_FILE = '04_Python_Intermedio\Ejercicios_algoritmo_Ordenamiento\Exercises.json'
            ...
            try:
                ...
                match option:
                    ...
                    case 1: 
                        ...
                        menu.bubble_sort_list()
                        input('Presione [Enter] para continuar \n')
                    case 2:
                        print(f'{menu.list_exercise[2]}') 
                        menu.reverse_bubble_sort_list()
                        input('Presione [Enter] para continuar')
                    # case 3: 
                    #     print(f'{menu.list_exercise[3]}')  
                    #     menu.show_doublelist() 
                    #     input('Presione [Enter] para continuar')
                    # case 4: 
